...
engine = pyttsx3.init('sapi5') # SAPI - Speech Application Programming Interface, dev by Microsoft. 
                               # For using speech recognition and synthesis within windows applications.
